        ...
        >
            ...
            <div className='flex justify-between ml-60 mr-60 h-[300px]  p-10'  >
                ...
                <section className='third flex flex-col h-full justify-start items-start w-[200px]' style={{ fontWeight: 400 }}>
                    <p className='mb-6 uppercase text-xl' style={{ fontWeight: 700 }}>about us:</p>
